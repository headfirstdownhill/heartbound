...
The tool does by itself the two things that were easy to get wrong by hand: the
curly apostrophes, and the emoji. It reports every change it makes, checks each
date's weekday against the calendar, and stops without writing anything if it
meets an emoji the game does not know.
...
ADD-LETTER.bat       letters/ -> the game, then rebuilds. The one to double-click
